  ...
  const response = await fetch("https://api.openai.com/v1/responses", {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        "For clear operational instructions such as close rooms, change rates, update availability, reply to a guest, or fix an OTA issue, choose operational_request. Do not promise it is done.",
